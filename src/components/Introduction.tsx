...
const Introduction = () => {
  return (
    <div className="w-full flex justify-center border-b-4 border-regal-blue pb-10 pt-4">
      <div className="flex flex-col tablet:flex-row justify-center tablet:gap-4 text-stone-950 rounded-md">
